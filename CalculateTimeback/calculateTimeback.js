javascript:
function addScreenTimer(screen) {
...
function checkIfScriptAlreadyRunning() {
    if (document.getElementById('calcBackSnipeButton') !== null) {
        UI.ErrorMessage('Erro! O script já está ativo. Por favor dê reload na página.', 3000);
        return false;
    }
    return true;
}
...
function backDisplaySnipeTooltip() {
    ...
    var dialogContent = '<div style="text-align:center;"><h3>Help</h3>O objetivo deste script é para facilitar o <b>calculo de backsnipes</b>.<br><br>' + 
    ...
    'do seu ecrã, em "<b>Hora do servidor</b>".<br><br></div>';
